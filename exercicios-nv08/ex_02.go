...
// EU fiz dessa forma mas a ideia do exercicio era outro.
...
// 	// Unmarshal recebe bytes e um ponteiro, Nesse caso eu passei o proprio s.
// 	// O exemplo da pasta cap_16_aplicações é bem legal de se ver também.
// }
